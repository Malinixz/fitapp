...
router.put('/days/:ID', auth.authToken, verifyParams(['ProtTotal', 'CarbTotal', 'FatTotal', 'CaloriesTotal']), dayController.updateDayProgress);
router.put('/days/:ID', auth.authToken, verifyParams(['ProtGoal', 'CarbGoal', 'FatGoal', 'CaloriesGoal']), dayController.updateDayGoals);
